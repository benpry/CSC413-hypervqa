...
sys.path.append("../")
sys.path.append("/content/drive/MyDrive/CSC413/")
...
def train_loop(args, train_loader, val_loader, valB_loader=None):
    ...
    if args.model_type in ['LSTM', 'CNN+LSTM', 'CNN+LSTM+SA', 'HyperVQA']:
    ...
    while t < args.num_iterations:
        ...
        for batch in train_loader:
            ...
            if args.model_type == 'PG':
                ...
                loss.backward()
                ee_optimizer.step()
            elif args.model_type in ['LSTM', 'CNN+LSTM', 'CNN+LSTM+SA', "HyperVQA"]:
